  ...
  return (
    <footer className="border-t border-white/5 bg-dark-800" role="contentinfo">
          ...
          <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="px-8 py-4 rounded-2xl glass border border-white/10 text-white font-semibold text-lg hover:border-white/30"
              >
                Browse Prompts
              </motion.a>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 glass rounded-xl flex items-center justify-center text-white/40 hover:text-neon-cyan hover:border-neon-cyan/30 border border-white/5 transition-all"
                >
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/25">
          <div>
